...
SCADA_HMI::SCADA_HMI(QObject *parent) : QObject(parent) {}

void SCADA_HMI::displayStatistics(double speed, int resistance, int incline, int heartRate, int stepCount, double caloriesBurned, double distance, QString clockMode) {
    emit updateUI(speed, resistance, incline, heartRate, stepCount, caloriesBurned, distance, clockMode);
}
